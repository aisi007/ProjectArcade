...
class MyGame(arcade.View):
    def __init__(self):
        ...
        self.virus_sound = arcade.load_sound('virus_sound.mp3')
    ...
    def setup(self):
        """Настройка игры"""
        basket = arcade.Sprite('basket.png', scale=0.3)
    ...
    def on_update(self, delta_time: float):
        ...
        for item in hit_list:
            ...
            if item.file == 'virus.png':
                self.virus_sound.play()
            if item.file == 'coin.png':
                self.coin_sound.play()
            if item.file != 'virus.png' and item.file != 'coin.png':
                self.sound.play()
